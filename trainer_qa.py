...
class QuestionAnsweringTrainer(Trainer):
    ...
    def evaluate(self, eval_dataset=None, eval_examples=None, ignore_keys=None):
        ...
        eval_examples = (
            self.eval_examples if eval_examples is None else eval_examples
        )  # 전처리 전
        ...
        try:
            ###TODO: return output with using huggingface prediction_loop###
            eval_loop = (
        ...
        if self.post_process_function is not None and self.compute_metrics is not None:
            ###TODO: return eval_preds with using huggingface post_process_function###
    ...
    def predict(self, test_dataset, test_examples, ignore_keys=None):
        ...
        ###TODO: return predictions with using huggingface post_process_function###
